...
class CObjectsShader : public CNONAnimateShader
{
public:
	CObjectsShader();
...
class BulletShader : public CIlluminatedTexturedShader
{
public:
	BulletShader();
...
/*================================================================================================*/
// TreeShader=======================================================================================
class StaticObjectShader : public CIlluminatedTexturedShader
{
public:
	StaticObjectShader();
	virtual ~StaticObjectShader();
