...
public:
	...
	void AnimateObjects(float fTimeElapsed, CCamera *pCCamera);
	...
	CWaterHeightmap			*m_pWater = NULL;
	CWaterHeightmap *GetWater() { return(m_pWater); }
...
protected:
	...
	WaterShader              *m_pWaterObjectShader = NULL;
