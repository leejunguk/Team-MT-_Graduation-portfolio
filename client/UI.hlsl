...
VS_UI_OUTPUT HPBAR_VS(uint nVertexID : SV_VertexID)
{
	VS_UI_OUTPUT output;
	...
	{
		output.position = float4(-0.58f, 0.85f, 0.0f, 1.0f);
		output.uv = float2(0.0f, -0.0f);
	}
	else if (nVertexID == 1)
	{
        output.position = float4(-0.58f + t, 0.85f, 0.0f, 1.0f);
		output.uv = float2(1.0f, 0.0f);
	}
	else if (nVertexID == 2 || nVertexID == 4)
	{
        output.position = float4(-0.58 + t, 0.82f, 0.0f, 1.0f);
		output.uv = float2(1.0f, 1.0f);
	}
	else if (nVertexID == 5)
	{
		output.position = float4(-0.58f, 0.82f, 0.0f, 1.0f);
		output.uv = float2(0.0f, 1.0f);
	}
...
VS_UI_OUTPUT TEDURI_VS(uint nVertexID : SV_VertexID)
{
	VS_UI_OUTPUT output;
	...
	{
		output.position = float4(0.0f, 0.90f, 0.0f, 1.0f);
		output.uv = float2(1.0f, 0.0f);
	}
	else if (nVertexID == 2 || nVertexID == 4)
	{
...
VS_UI_OUTPUT MGIKON_VS(uint nVertexID : SV_VertexID)
{
    VS_UI_OUTPUT output;

    if (nVertexID == 0 || nVertexID == 3)
    {
        output.position = float4(-0.82f, 0.85f, 0.0f, 1.0f);
        output.uv = float2(0.0f, -0.0f);
    }
    else if (nVertexID == 1)
    {
        output.position = float4(-0.62f, 0.85f, 0.0f, 1.0f);
        output.uv = float2(1.0f, 0.0f);
    }
    else if (nVertexID == 2 || nVertexID == 4)
    {
        output.position = float4(-0.62f, 0.78f, 0.0f, 1.0f);
        output.uv = float2(1.0f, 1.0f);
    }
    else if (nVertexID == 5)
    {
        output.position = float4(-0.82f, 0.78f, 0.0f, 1.0f);
        output.uv = float2(0.0f, 1.0f);
    }
...
VS_UI_OUTPUT TEDURI_BOSS_VS(uint nVertexID : SV_VertexID)
{
    VS_UI_OUTPUT output;

    if (nVertexID == 0 || nVertexID == 3)
    {
        output.position = float4(-0.88f, -0.68f, 0.0f, 1.0f);
        output.uv = float2(0.0f, -0.0f);
    }
    else if (nVertexID == 1)
    {
    ...
    {
        output.position = float4(0.88f, -0.84f, 0.0f, 1.0f);
        output.uv = float2(1.0f, 1.0f);
    }
    else if (nVertexID == 5)
    {
...
VS_UI_OUTPUT BOSS_HPBAR_VS(uint nVertexID : SV_VertexID)
{
    VS_UI_OUTPUT output;

    
    float t = 0.0105f * bosshp;

    if (nVertexID == 0 || nVertexID == 3)
    {
        output.position = float4(-0.20f, -0.74f, 0.0f, 1.0f);
        output.uv = float2(0.0f, -0.0f);
    }
    else if (nVertexID == 1)
    {
        output.position = float4(-0.20f + t, -0.74f, 0.0f, 1.0f);
        output.uv = float2(1.0f, 0.0f);
    }
    else if (nVertexID == 2 || nVertexID == 4)
    {
        output.position = float4(-0.20f + t, -0.76f, 0.0f, 1.0f);
        output.uv = float2(1.0f, 1.0f);
    }
    else if (nVertexID == 5)
    {
        output.position = float4(-0.20f, -0.76f, 0.0f, 1.0f);
        output.uv = float2(0.0f, 1.0f);
    }
